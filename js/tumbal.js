    ...
    "9": {
        ...
        "1": {
            ...
            "KAMIS": [
                ...
                { time: "11.00 - 11.40", subject: "Seni Budaya" },

                { time: "11.40 - 12.20", subject: "Seni Budaya" },
        ...
        "2": {
            ...
            "KAMIS": [
                ...
                { time: "07.30 - 08.10", subject: "Seni Budaya" },

                { time: "08.10 - 08.50", subject: "Seni Budaya" },
        ...
        "3": {
            ...
            "KAMIS": [
                ...
                { time: "12.20 - 13.00", subject: "Seni Budaya" },
            ...
            "JUMAT": [
                ...
                { time: "08.00 - 08.40", subject: "Seni Budaya" },
        ...
        "4": {
            ...
            "KAMIS": [
                ...
                { time: "08.50 - 09.30", subject: "Seni Budaya" },

                { time: "09.30 - 10.10", subject: "Seni Budaya" },
...
var funFacts = [
...

    {
        ...
        items: [
            ...
            "Sicilia Ledy, Hesty Lontoh, Marjeine Dalonto (Magister Pendidikan/M.Pd)",
...
function switchScreen(fromId, toId) {
    ...
    var toScreen = document.getElementById(toId);
...
function showRombelSelection(classNum) {
    ...
    var rombelGrid = document.getElementById('rombelGrid');
...
function showSchedule(day) {
    ...
    document.getElementById('scheduvaritle').innerText = `${day} - Rombel ${currentRombel}`;
...
function showFunFacts() {
    ...
    funFacts.forEach(cat => {
        ...
        // PERBAIKAN: Mengganti 'cat.facts' menjadi 'cat.items'

        var items = cat.items.map(f => `<li class="fact-item">${f}</li>`).join('');
...
function initEventListeners() {
    ...
    themeToggle.onclick = toggvarheme;
...
var tombolInput = document.getElementById('tombolAksi');
var teksHasil = document.getElementById('teksStatus');

if (tombolInput) {
    tombolInput.addEventListener('click', () => {
        if (teksHasil) {
            teksHasil.textContent = "JS HIDUP 🔥 Semua event bekerja!";
        }
