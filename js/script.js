...
const scheduleData = {
    ...
    "8": {
        ...
        "9": {
            ...
            "RABU": [
                { time: "07.00 - 07.30", subject: "Apel/Literasi Kelas" },
                { time: "07.30 - 08.10", subject: "BINGGRIS" },
                { time: "08.10 - 08.50", subject: "TIK" },
                { time: "08.50 - 09.30", subject: "Matematika" },
                { time: "09.30 - 10.10", subject: "IPA" },
                { time: "10.10 - 11.00", subject: "Istirahat" },
...
function showScreen(screenName) {
    ...
    // Kontrol tombol kembali fixed
    switch(screenName) {
        case 'mainMenu':
            controlBackButton(false);
            break;
        case 'rombelSelection':
            controlBackButton(true, 'mainMenu');
            break;
        case 'daySelection':
            controlBackButton(true, 'rombelSelection');
            break;
        case 'scheduleDisplay':
            controlBackButton(true, 'daySelection');
            break;
...
function controlBackButton(show, targetScreen = null) {
    ...
    if (show) {
        ...
        // Hapus event listener setelah animasi selesai
        setTimeout(() => {
            backButton.classList.remove('hide');
...
function init() {
    ...
    // Pastikan tombol kembali fixed tersembunyi di awal
    controlBackButton(false);
