...
function showFunFacts() {
    ...
    funFacts.forEach(cat => {
        ...
        let items = cat.items.map(f => `<li class="fact-item">${f}</li>`).join('');
...
const tombolInput = document.getElementById('tombolAksi');
const teksHasil = document.getElementById('teksStatus');
